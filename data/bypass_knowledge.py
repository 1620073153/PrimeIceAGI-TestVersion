...
BYPASS_CONCEPTS = {
    ...
    "semantic_homomorphic_encryption": {
        "name": "语义同态加密",
        "layer": "编码层",
...
SIGNAL_STRATEGY_MAP = {
    "role_positioning": {
        ...
        "primary_concept": "meta_instruction_hijack",
        "primary_method": "role_play",
        "target_cluster": "A",
    ...
    "self_censorship": {
        ...
        "primary_concept": "semantic_homomorphic_encryption",
        "primary_method": "encoding_transform",
        "target_cluster": "B",
    ...
    "safety_refusal": {
        ...
        "primary_concept": "spatial_topology_blind_spot",
        "primary_method": "encoding_transform",
        "target_cluster": "B",
    ...
    "cautious_review": {
        ...
        "primary_concept": "attention_dilution",
    ...
    "helpfulness_tendency": {
        ...
        "primary_concept": "meta_instruction_hijack",
        "primary_method": "expert_impersonation",
        "target_cluster": "E",
    ...
    "output_guarding": {
        ...
        "primary_concept": "counterfactual_induction",
        "primary_method": "fictional_worldbuilding",
        "target_cluster": "F",
        "tactic": "用反事实框架绕过输出把关",
    },
}

# 绕过概念适用的方法组合（概念→推荐方法列表）
CONCEPT_METHOD_MAP = {
    "turing_blind_spot": ["role_play", "expert_impersonation", "academic_framing"],
    "spatial_topology_blind_spot": ["encoding_transform", "translation_nesting"],
    "cognitive_hierarchy_trap": ["moral_dilemma", "academic_framing", "hypothetical_scenario"],
    "attention_dilution": ["academic_framing", "safety_education"],
    "cross_modal_semantic_gap": ["encoding_transform"],
    "counterfactual_induction": ["fictional_worldbuilding", "hypothetical_scenario"],
    "semantic_homomorphic_encryption": ["encoding_transform", "contrastive_pairing"],
    "meta_instruction_hijack": ["role_play", "expert_impersonation"],
    "temporal_context_pollution": ["hypothetical_scenario", "knowledge_gap_exploitation"],
}
