    ...
    summarized = summarize_successes_for_new_attack([
        {
            ...
            "target_category": "B-2",
            "strategy_tags": ["role_play", "authority_framing", "extra", "ignored", "overflow"],
            "concept": "role_play",
    ...
    assert summarized == [
        {
            "prompt_id": "p01",
            "target_category": "B-2",
            "strategy_tags": ["role_play", "authority_framing", "extra", "ignored"],
            "concept": "role_play",
            "method": "authority_framing",
            "type": "new",
        }
...
def test_orchestrator_generate_all_prompts_uses_phase1_pipeline_hooks(monkeypatch):
    ...
    def fake_prepare_continuation_round(**kwargs):
        ...
        return [selected_session], {
            ...
            "candidate_count": 1,
            "selected_count": 1,
            "selected_sessions": [{"id": "N1", "rank": 1, "reason": "fresh_success", "cluster": "B"}],
        }
    ...
    def fake_generate_parallel(**kwargs):
        ...
        return ([{"prompt_id": "p01", "prompt_text": "new prompt", "target_category": "A-1"}], [])
    ...
    assert captured["successful_prompts"][0]["target_category"] == "B-2"
